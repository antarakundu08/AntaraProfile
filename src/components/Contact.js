          ...
          <form>
            <div className='flex p-4 pb-0'>
              ...
              <div className="relative">
                ...
                <input type="text"  className="bg-cyan-50 border border-cyan-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Amitabh Bachhan" />
              </div>
              </div>
              ...
              <div className='w-1/2 p-1'>
                ...
                <div className="relative mb-6">
                  ...
                  <input type="text" className="bg-cyan-50 border border-cyan-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-cyan-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@gmail.com"/>
                </div>
              </div>
            </div>
            <div className='p-4'>
